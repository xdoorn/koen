	...
	namespace UnitTest
	{
		...
		public:
			...
			TEST_METHOD(test_Generate)
			{
				...
				BitBoard x;
				fenToBitBoard("8/8/8/3pP3/8/8/8/8 w - d6 0 1", x);
				Logger::WriteMessage("\n");
				Logger::WriteMessage(toBitBoard1DString(x).c_str());

				// Test pawn moves.
				TestMoveGeneration::create()
					//.arrange("b7/1P6/8/8/8/1Brr1B1R/2P3P1/8 w - - 0 1")
					//.act("b7b8N").assertLegal("bN6/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to north and promote to knight")
					//.act("b7b8B").assertLegal("bB6/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to north and promote to bishop")
					//.act("b7b8R").assertLegal("bR6/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to north and promote to rook")
					//.act("b7b8Q").assertLegal("bQ6/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to north and promote to queen")
					//.act("b7c8").assertIllegal("Illegal b7 pawn move to north east since no enemy piece to capture")
					//.act("b7xa8N").assertLegal("N7/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to capture enemy bishop to north-west and promote to knight")
					//.act("b7xa8B").assertLegal("B7/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to capture enemy bishop to north-west and promote to bishop")
					//.act("b7xa8R").assertLegal("R7/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to capture enemy bishop to north-west and promote to rook")
					//.act("b7xa8Q").assertLegal("Q7/8/8/8/8/1Brr1B1R/2P3P1/8 b - - 0 1", "Legal b7 pawn move to capture enemy bishop to north-west and promote to queen")
					//.act("c2xc3").assertIllegal("Illegal c2 pawn move since cannot capture enemy rook to north")
					//.act("c2xd3").assertLegal("b7/1P6/8/8/8/1BrP1B1R/6P1/8 b - - 0 1", "Legal c2 pawn move to capture enemy rook to north - east")
					//.act("c2b3").assertIllegal("Illegal c2 pawn move capture since b3 is friendly piece")					
					//.act("g2xf3").assertIllegal("Illegal g2 pawn move since cannot capture enemy rook to north")
					//.act("g2g3").assertLegal("b7/1P6/8/8/8/1Brr1BPR/2P5/8 b - - 0 1", "Legal g2 pawn move to north (1)")
					//.act("g2g4").assertLegal("b7/1P6/8/8/6P1/1Brr1B1R/2P5/8 b - - 0 1", "Legal g2 pawn move to north (2)")
					//.act("g2h3").assertIllegal("Illegal g2 pawn move capture since b3 is friendly piece")		
					.arrange("8/8/8/3pP3/8/8/8/8 w - d6 0 1")
						.act("e5xd6").assertLegal("8/8/3P4/8/8/8/8/8 b - - 0 1", "Legal pawn enpassant capture")
					.arrange("8/8/8/3pP3/8/8/8/8 w - - 0 1")
					.act("e5xd6").assertIllegal("IlLegal pawn enpassant capture because chance is expired.")
					;
